...
#define CAN_CMD_DLG_START_LOG	0x03
#define CAN_CMD_DLG_STOP_LOG	0x04
...
#define CAN_DATA_DLGR_TGL	0xFFE3
#define CAN_DATA_TC_TGL		0xFFE4
#define CAN_DATA_LC_TGL 	0xFFE5
#define CAN_DATA_TC_SET 	0xFFE6
#define CAN_DATA_LC_SET 	0xFFE7
