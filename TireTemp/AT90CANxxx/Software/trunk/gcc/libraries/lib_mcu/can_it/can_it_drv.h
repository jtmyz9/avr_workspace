...
#ifndef _CAN_IT_DRV_H_
#define _CAN_IT_DRV_H_
...
#define BUS_OFF_MSK (1<<BOFFIT)                                          //! MaSK for BUS-OFF INTerrupt
#define BUFF_OK_MSK (1<<BXOK)                                            //! MaSK for Buffer Receive INTerrupt
#define INT_GEN_MSK ((1<<BOFFIT)|(1<<BXOK)|(ERR_GEN_MSK))                //! MaSK for GENeral INTerrupts
#define CAN_INT_MSK (1<<CANIT)                                           //! MaSK for CAN INTerrupt
...
#define Can_conf_bt()     { CANBT1=CONF_CANBT1; CANBT2=CONF_CANBT2; CANBT3=CONF_CANBT3; }
    // ----------
#define Can_enable_mob_int()     { CANGIE |= (1<<ENIT)|(1<<ENRX)|(1<<ENTX)|(1<<ENERR); CANIE1 = 0xFF; CANIE2 = 0xFF; } 
#define Can_enable_global_int()  ( CANGIE |= (1<<ENIT)|(1<<ENERG)|(1<<ENBOFF) )
    // ----------
...
//!
extern U8 can_get_general_interrupt(void);

//______________________________________________________________________________

#endif // _CAN_IT_DRV_H_
