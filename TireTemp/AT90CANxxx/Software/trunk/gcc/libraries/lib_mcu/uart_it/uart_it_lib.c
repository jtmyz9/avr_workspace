...
,-----------------------------------,\r\n\
| AT90CANxx Library Version 3.30   / (R)\r\n\
'---------------------------------'\r\n\n";

U8 txt_small_logo_atmel[]="--- AT90CANxx Library Version 3.30 ---\r\n";
...
//!
//! @param  Mode (c.f. predefined modes in "uart_it_drv.h" file)
